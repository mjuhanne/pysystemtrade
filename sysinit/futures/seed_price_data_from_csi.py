"""
    This script scans a target directory containing .csv files created by CSI's Unfair Advantage.
...
if __name__ == "__main__":
    ...
    data = create_arctic_csv_datablob(csv_datapath, csv_config,"Seed-price-data-from-CSI")

    print("Get initial price data from CSI .csv files")
